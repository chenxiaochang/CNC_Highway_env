...
class IntersectionEnv(AbstractEnv):
    ...
    def _make_road(self) -> None:
        ...
        for corner in range(4):
            ...
            end = rotation @ np.flip([lane_width / 2, outer_distance], axis=0)  # flip:matrix reverse 矩阵翻转
    ...
    @property
    def has_arrived(self, exit_distance=25) -> bool: # judge weather the ego vehicle is arrival the goal destination
